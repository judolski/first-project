...
<body style="" class="container body" > 
          <br><br><br><h2 class="tshadowlogin hfontsize container" style="color: darkred; background: black; width: 385px;">ADMINISTRATIVE LOGIN</h2><br>
